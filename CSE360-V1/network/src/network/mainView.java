...
//================ called by listPtahsBtnActionPreformed & FileWrite Function ==========================
    ...
    private void listPathsBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void listIndividualNodesActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    private void changeDurationActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if(list.isEmpty() == true){
            errorLbl.setVisible(true);
            errorLbl.setText("There are no nodes in the list");
        }else{
    ...
    private void reportTitleTxtActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    ...
    private void criticalPathBtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
